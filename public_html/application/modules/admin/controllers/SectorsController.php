...
class Admin_SectorsController extends Controller {

    protected $singular = "Sector";
    protected $plural = "todos los Sectores";
    protected $messageDelete = "¿Esta seguro que desea eliminar este Sector?";
    protected $title = "Sectores";

    public function init() {

        $fields = array(
            array('field' => 'sc_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
            array('field' => 'sc_name', 'label' => 'Nombre', 'required' => 'required', 'list' => true, 'search' => true, 'order' => true),
            array('field' => 'sc_order', 'label' => 'Orden', 'required' => 'required', 'list' => true, 'search' => true, 'order' => true,'type'=>'number'),
        );
        $actions = array(
        ...
        $this->model = new Model_DBTable_Sector();
    }
}
