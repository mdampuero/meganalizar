...
class Admin_GroupsController extends Controller {

    protected $singular = "Grupo de Bioquímico";
    protected $plural = "todos los Grupos de Bioquímicos";
    protected $messageDelete = "¿Esta seguro que desea eliminar este Grupo de Bioquímico?";
    protected $title = "Grupos de Bioquímicos";

    public function init() {

        $fields = array(
            array('field' => 'gr_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
            array('field' => 'gr_name', 'label' => 'Nombre', 'required' => 'required', 'list' => true, 'search' => true, 'order' => true)
        );
        $actions = array(
        ...
        $this->model = new Model_DBTable_Group();
    }
}
