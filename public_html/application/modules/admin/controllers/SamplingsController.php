...
require_once 'Sampling.php';
require_once 'Controller.php';

class Admin_SamplingsController extends Controller {
    ...
    public function init() {
        ...
        $fields = array(
            array('field' => 'sa_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
            array('field' => 'sa_name', 'label' => 'Título', 'required' => 'required', 'list' => true, 'search' => true, 'order' => true),
            array('field' => 'sa_file', 'label' => 'Archivo', 'list' => true, 'search' => true, 'order' => true,'type'=>'file'),
        );
        $actions = array(
        ...
        $this->model = new Model_DBTable_Sampling();
    }
}
