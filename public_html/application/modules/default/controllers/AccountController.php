...
class AccountController extends ControllerDefault {
	...
	public function indexAction() {
		try {
			$this->view->dates=$this->orden->getDistinctFecha($this->view->login['BMatricula']);
			if($this->view->parameters['muestra']){
				$result=$this->orden->getByMuestraMatricula($this->view->parameters['muestra'],$this->view->login['BMatricula']);
			}else{
				...
				$result=$this->orden->getByDate($this->_helper->Date->getDateFormatted(str_replace('/', '-', $this->view->fecha)),$this->view->login['BMatricula'],$this->view->parameters['sort'],$this->view->parameters['order']);
            }
	...
	public function loadAction(){  
		...
		$this->view->results=$this->orden_estudio_prueba->getAllByMuestra($this->view->parameters['muestra']);
